 ...
 *
 * Outputs:
 *   - scripts/tokens/token-mapping.json  (structured, machine-readable)
 *   - scripts/tokens/token-mapping.md    (human-readable table)
 *
 * Usage:
 *   node scripts/tokens/generate-token-mapping.mjs
 *
