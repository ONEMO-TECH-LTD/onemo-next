...
function Loader( editor ) {
		...
		switch ( extension ) {
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setLibraryPath( 'vendor/three/examples/jsm/libs/rhino3dm/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setDecoderPath( 'vendor/three/examples/jsm/libs/draco/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setPath( 'vendor/three/examples/models/ldraw/officialLibrary/' );
	...
	async function createGLTFLoader( manager ) {
		...
		ktx2Loader.setTranscoderPath( 'vendor/three/examples/jsm/libs/basis/' );
