...
This is an owned in-repo port of the ONEMO three.js editor fork. The editor source lives in `editor-js/`; Vite resolves `three`, `three/webgpu`, and `three/addons/*` from `node_modules` instead of a vendored copy.
