...
export const fields: AttributeReference[]  = [{
    ...
    description: '',
    url: '/reference/api/engine/classes/ScreenComponent.html'
}, {
    ...
    url: '/reference/api/engine/classes/ScreenComponent.html#screenspace'
}, {
    name: 'screen:resolution',
    title: 'resolution',
    subTitle: '{pc.Vec2}',
    description: 'The resolution of the screen.',
    url: '/reference/api/engine/classes/ScreenComponent.html#resolution'
}, {
    ...
    url: '/reference/api/engine/classes/ScreenComponent.html#referenceresolution'
}, {
...
<li><b>Blend</b> (<code>"blend"</code>): Screen adjusts between the window resolution and the reference resolution using Scale Blend.</li>
    ...
    url: '/reference/api/engine/classes/ScreenComponent.html#scalemode'
}, {
    ...
    url: '/reference/api/engine/classes/ScreenComponent.html#scaleblend'
}, {
    ...
    url: '/reference/api/engine/classes/ScreenComponent.html#priority'
}];
