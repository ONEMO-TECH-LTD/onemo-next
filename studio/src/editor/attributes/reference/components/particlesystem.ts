...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#autoplay'
}, {
    name: 'particlesystem:alignToMotion',
    title: 'alignToMotion',
    subTitle: '{Boolean}',
    description: 'Orient particle in their direction of motion.',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#aligntomotion'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#alphagraph'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animtilesx'
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animtilesy'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animstartframe'
}, {
    name: 'particlesystem:animNumFrames',
    title: 'animNumFrames',
    subTitle: '{Number}',
    description: 'Number of sprite sheet frames in each animation',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animnumframes'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animnumanimations'
}, {
    name: 'particlesystem:animIndex',
    title: 'animIndex',
    subTitle: '{Number}',
    description: 'The animation from the sprite sheet to play for each particle in the system',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animindex'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#randomizeanimindex'
}, {
    name: 'particlesystem:animSpeed',
    title: 'animSpeed',
    subTitle: '{Number}',
    description: 'Sprite sheet animation speed. 1 = particle lifetime, 2 = twice during lifetime etc...',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animspeed'
}, {
    name: 'particlesystem:animLoop',
    title: 'animLoop',
    subTitle: '{Boolean}',
    description: 'If true then the sprite sheet animation will repeat indefinitely',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#animloop'
}, {
...
<li><b>Multiply</b> (<code>pc.BLEND_MULTIPLICATIVE</code>): Multiplies particle color with the background. Good for shadows and dark effects.</li>
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#blend'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#colorgraph'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#colormap'
}, {
...
<li><b>Emitter Normal</b> (<code>pc.PARTICLEORIENTATION_EMITTER</code>): Particles face along a direction relative to the emitter entity's transform.</li>
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#orientation'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#particlenormal'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#depthsoftening'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#depthwrite'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#emitterextents'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#emitterradius'
}, {
...
<li><b>Sphere</b> (<code>pc.EMITTERSHAPE_SPHERE</code>): Particles spawn within a sphere-shaped volume defined by Emitter Radius.</li>
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#emittershape'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#lighting'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#localvelocitygraph'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#loop'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#mesh'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#renderasset'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#normalmap'
}, {
    name: 'particlesystem:numParticles',
    title: 'numParticles',
    subTitle: '{Number}',
    description: 'The maximum number of particles managed by this particle system.',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#numparticles'
}, {
    name: 'particlesystem:paused',
    title: 'paused',
    subTitle: '{Boolean}',
    description: 'Pauses or unpauses the simulation.',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#paused'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#prewarm'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#rate'
}, {
    name: 'particlesystem:localSpace',
    title: 'localSpace',
    subTitle: '{Boolean}',
    description: 'Binds particles to emitter node transformation.',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#localspace'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#screenspace'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#rotationspeedgraph'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#scalegraph'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#radialspeedgraph'
}, {
...
<li><b>Oldest First</b> (<code>pc.PARTICLESORT_OLDER_FIRST</code>): Particles are sorted by age, oldest first.</li>
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#sort'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#startangle'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#stretch'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#velocitygraph'
}, {
    name: 'particlesystem:wrap',
    title: 'wrap',
    subTitle: '{Boolean}',
    description: 'Enables wrap bounds.',
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#wrap'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#wrapbounds'
}, {
    ...
    url: '/reference/api/engine/classes/ParticleSystemComponent.html#layers'
}];
