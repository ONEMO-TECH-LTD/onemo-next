...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/AnimComponent.html'
}, {
    name: 'anim:activate',
    title: 'activate',
    subTitle: '{Boolean}',
    description: 'If checked, the component will start playing the anim state graph on load.',
    url: '/reference/api/engine/classes/AnimComponent.html#activate'
}, {
    name: 'anim:speed',
    title: 'speed',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/AnimComponent.html#speed'
}, {
    name: 'anim:rootBone',
    title: 'rootBone',
    subTitle: '{pc.Entity}',
    description: 'The root of the entity hierarchy that all model transform animations should play on.',
    url: '/reference/api/engine/classes/AnimComponent.html#rootbone'
}, {
    ...
    url: '/reference/api/engine/classes/AnimComponent.html#normalizeweights'
}, {
    ...
    url: '/reference/api/engine/classes/AnimComponent.html#stategraphasset'
}];
