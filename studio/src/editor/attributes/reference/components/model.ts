...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/ModelComponent.html'
}, {
    name: 'model:isStatic',
    title: 'isStatic',
    subTitle: '{Boolean}',
    description: 'Mark model as non-movable (optimization).',
    url: '/reference/api/engine/classes/ModelComponent.html#isstatic'
}, {
    name: 'model:asset',
    title: 'asset',
    subTitle: '{Number}',
    description: 'The model asset rendered by this model component. Only a single model can be rendered per model component.',
    url: '/reference/api/engine/classes/ModelComponent.html#asset'
}, {
    ...
    url: '/reference/api/engine/classes/ModelComponent.html#castshadows'
}, {
    name: 'model:materialAsset',
    title: 'materialAsset',
    subTitle: '{Number}',
    description: 'The material that will be used to render the model (only applies to primitives)',
    url: '/reference/api/engine/classes/ModelComponent.html#materialasset'
}, {
    ...
    url: '/reference/api/engine/classes/ModelComponent.html#receiveshadows'
}, {
    name: 'model:type',
    title: 'type',
    subTitle: '{String}',
...
<li><b>Plane</b> (<code>"plane"</code>): Render a procedural plane primitive.</li>
    ...
    url: '/reference/api/engine/classes/ModelComponent.html#batchgroupid'
}, {
    ...
    url: '/reference/docs/user-manual/graphics/lighting/runtime-lightmaps/#lightmapping-settings'
}, {
    name: 'model:layers',
    title: 'layers',
    subTitle: '{Number[]}',
    ...
    url: '/reference/api/engine/classes/ModelComponent.html#layers'
}, {
