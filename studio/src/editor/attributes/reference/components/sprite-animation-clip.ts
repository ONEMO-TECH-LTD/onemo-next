...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/SpriteAnimationClip.html'
}, {
    ...
    url: '/reference/api/engine/classes/SpriteAnimationClip.html#name'
}, {
