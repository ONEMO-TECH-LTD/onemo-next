...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/LayoutChildComponent.html#fitwidthproportion'
}, {
    ...
    url: '/reference/api/engine/classes/LayoutChildComponent.html#fitheightproportion'
}, {
    ...
    url: '/reference/api/engine/classes/LayoutChildComponent.html#excludefromlayout'
}];
