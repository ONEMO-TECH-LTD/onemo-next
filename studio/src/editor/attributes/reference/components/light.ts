...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/LightComponent.html'
}, {
    name: 'light:isStatic',
    title: 'isStatic',
    subTitle: '{Boolean}',
    description: 'Mark light as non-movable (optimization).',
    url: '/reference/api/engine/classes/LightComponent.html#isstatic'
}, {
    name: 'light:castShadows',
    title: 'castShadows',
    subTitle: '{Boolean}',
    description: 'If checked, the light will cause shadow casting models to cast shadows.',
    url: '/reference/api/engine/classes/LightComponent.html#castshadows'
}, {
    name: 'light:color',
    title: 'color',
    subTitle: '{pc.Color}',
    description: 'The color of the emitted light.',
    url: '/reference/api/engine/classes/LightComponent.html#color'
}, {
...
<li><b>Inverse Squared</b> (<code>pc.LIGHTFALLOFF_INVERSESQUARED</code>): Physically accurate falloff where intensity decreases with the square of distance.</li>
    ...
    url: '/reference/api/engine/classes/LightComponent.html#falloffmode'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#innerconeangle'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#shadowbias'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#shadowdistance'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#shadowintensity'
}, {
    name: 'light:numCascades',
    title: 'numCascades',
    subTitle: '{Number}',
    description: 'Number of shadow cascades.',
    url: '/reference/api/engine/classes/LightComponent.html#numcascades'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#cascadedistribution'
}, {
    name: 'light:shadowResolution',
    title: 'shadowResolution',
    subTitle: '{Number}',
    description: 'The size of the texture used for the shadow map.',
    url: '/reference/api/engine/classes/LightComponent.html#shadowresolution'
}, {
    name: 'light:type',
    title: 'type',
    subTitle: '{String}',
...
<li><b>Spot</b> (<code>"spot"</code>): Emits light in a cone shape, like a flashlight or stage light.</li>
    ...
    url: '/reference/api/engine/classes/LightComponent.html#shadowupdatemode'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#shadowtype'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#vsmblurmode'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#vsmblursize'
}, {
    name: 'light:vsmBias',
    title: 'vsmBias',
    subTitle: '{Number}',
    description: 'Constant depth offset applied to a shadow map that enables the tuning of shadows in order to eliminate rendering artifacts, namely \'shadow acne\' and \'peter-panning\'',
    url: '/reference/api/engine/classes/LightComponent.html#vsmbias'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#cookieasset'
}, {
    name: 'light:cookieIntensity',
    title: 'cookieIntensity',
    subTitle: '{Number}',
    description: 'Projection texture intensity.',
    url: '/reference/api/engine/classes/LightComponent.html#cookieintensity'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#cookiefalloff'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#cookiechannel'
}, {
    name: 'light:cookieAngle',
    title: 'cookieAngle',
    subTitle: '{Number}',
    description: 'Angle for spotlight cookie rotation.',
    url: '/reference/api/engine/classes/LightComponent.html#cookieangle'
}, {
    name: 'light:cookieOffset',
    title: 'cookieOffset',
    subTitle: '{pc.Vec2}',
    description: 'Spotlight cookie position offset.',
    url: '/reference/api/engine/classes/LightComponent.html#cookieoffset'
}, {
    name: 'light:cookieScale',
    title: 'cookieScale',
    subTitle: '{pc.Vec2}',
    description: 'Spotlight cookie scale.',
    url: '/reference/api/engine/classes/LightComponent.html#cookiescale'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#penumbrasize'
}, {
    ...
    url: '/reference/api/engine/classes/LightComponent.html#penumbrafalloff'
}, {
    name: 'light:layers',
    title: 'layers',
    subTitle: '{Number[]}',
    description: 'The layers that this light will affect.',
    url: '/reference/api/engine/classes/LightComponent.html#layers'
}];
