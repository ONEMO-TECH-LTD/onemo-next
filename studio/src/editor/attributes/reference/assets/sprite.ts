...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/Sprite.html'
}, {
    name: 'asset:sprite:pixelsPerUnit',
    title: 'pixelsPerUnit',
    subTitle: '{Number}',
    description: 'The number of pixels that represent one Studio unit. You can use this value to change the rendered size of your sprites.',
    url: '/reference/api/engine/classes/Sprite.html#pixelsperunit'
}, {
    name: 'asset:sprite:renderMode',
    title: 'renderMode',
    subTitle: '{Number}',
    description: 'The render mode of the Sprite Asset. It can be Simple, Sliced or Tiled.',
    url: '/reference/api/engine/classes/Sprite.html#rendermode'
}, {
    ...
    url: '/reference/api/engine/classes/Sprite.html#textureatlasasset'
}];
