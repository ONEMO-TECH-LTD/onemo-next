...
export async function buildRuntimeBundle({ packageOutput, outDir, nodeModulesDir }) {
  validatePackage(packageOutput);
  ...
  return { ...result, buildHash: sha256(canonicalJson(result)), publicDir };
}

function validatePackage(output) {
