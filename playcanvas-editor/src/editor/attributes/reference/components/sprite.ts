...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html'
}, {
    name: 'sprite:type',
    title: 'type',
    subTitle: '{String}',
...
<li><b>Animated</b> (<code>pc.SPRITETYPE_ANIMATED</code>): Can play Sprite Animation Clips.</li>
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#type'
}, {
    name: 'sprite:color',
    title: 'color',
    subTitle: '{pc.Color}',
    description: 'The color tint of the Sprite.',
    url: '/reference/api/engine/classes/SpriteComponent.html#color'
}, {
    name: 'sprite:opacity',
    title: 'opacity',
    subTitle: '{Number}',
    description: 'The opacity of the Sprite.',
    url: '/reference/api/engine/classes/SpriteComponent.html#opacity'
}, {
    name: 'sprite:spriteAsset',
    title: 'spriteAsset',
    subTitle: '{pc.Asset}',
    description: 'The Sprite Asset used by the Sprite Component.',
    url: '/reference/api/engine/classes/SpriteComponent.html#spriteasset'
}, {
    name: 'sprite:frame',
    title: 'frame',
    subTitle: '{Number}',
    description: 'The frame of the Sprite Asset that the Sprite Component will render.',
    url: '/reference/api/engine/classes/SpriteComponent.html#frame'
}, {
    name: 'sprite:flipX',
    title: 'flipX',
    subTitle: '{Boolean}',
    description: 'Flips the X axis when rendering a Sprite.',
    url: '/reference/api/engine/classes/SpriteComponent.html#flipx'
}, {
    name: 'sprite:flipY',
    title: 'flipY',
    subTitle: '{Boolean}',
    description: 'Flips the Y axis when rendering a Sprite.',
    url: '/reference/api/engine/classes/SpriteComponent.html#flipy'
}, {
    name: 'sprite:size',
    title: 'size',
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#width'
}, {
    name: 'sprite:width',
    title: 'width',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#height'
}, {
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#draworder'
}, {
    name: 'sprite:speed',
    title: 'speed',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#autoplayclip'
}, {
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#batchgroupid'
}, {
    name: 'sprite:addClip',
    title: 'Add Clip',
    ...
    url: '/reference/api/engine/classes/SpriteComponent.html#layers'
}];
