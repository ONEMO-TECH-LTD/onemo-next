...
export const fields: AttributeReference[]  = [{
    ...
    description: '',
    url: '/reference/api/engine/classes/ElementComponent.html'
}, {
    name: 'element:type',
    title: 'type',
...
<li><b>Group</b> (<code>pc.ELEMENTTYPE_GROUP</code>): A container for other elements. Does not render anything itself.</li>
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#type'
}, {
    name: 'element:preset',
    title: 'preset',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#fontasset'
}, {
    name: 'element:textureAsset',
    title: 'textureAsset',
    subTitle: '{pc.Asset}',
    description: 'The texture to be used by the Element.',
    url: '/reference/api/engine/classes/ElementComponent.html#textureasset'
}, {
    name: 'element:spriteAsset',
    title: 'spriteAsset',
    subTitle: '{pc.Asset}',
    description: 'The sprite to be used by the Element.',
    url: '/reference/api/engine/classes/ElementComponent.html#spriteasset'
}, {
    name: 'element:spriteFrame',
    title: 'spriteFrame',
    subTitle: '{Number}',
    description: 'The frame from the Sprite Asset to render.',
    url: '/reference/api/engine/classes/ElementComponent.html#spriteframe'
}, {
    name: 'element:pixelsPerUnit',
    title: 'pixelsPerUnit',
    subTitle: '{Number}',
    description: 'The number of pixels that correspond to one Studio unit. Used when using 9 Sliced Sprite Assets to control the thickness of the borders. If this value is not specified the Element component will use the pixelsPerUnit value from the Sprite Asset.',
    url: '/reference/api/engine/classes/ElementComponent.html#pixelsperunit'
}, {
    name: 'element:materialAsset',
    title: 'materialAsset',
    subTitle: '{pc.Asset}',
    description: 'The material to be used by the element.',
    url: '/reference/api/engine/classes/ElementComponent.html#materialasset'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#autofitwidth'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#autofitheight'
}, {
    name: 'element:autoHeight',
    title: 'autoHeight',
    subTitle: '{Boolean}',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#width'
}, {
    name: 'element:width',
    title: 'width',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#height'
}, {
    name: 'element:margin',
    title: 'margin',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#margin'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#alignment'
}, {
    name: 'element:rect',
    title: 'rect',
    subTitle: '{pc.Vec4}',
    description: 'The u, v, width and height of the rectangle that represents the portion of the texture that this image maps to.',
    url: '/reference/api/engine/classes/ElementComponent.html#rect'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#fontsize'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#lineheight'
}, {
    name: 'element:wrapLines',
    title: 'wrapLines',
    subTitle: '{Boolean}',
    description: 'Whether to automatically wrap lines based on the element width.',
    url: '/reference/api/engine/classes/ElementComponent.html#wraplines'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#maxlines'
}, {
    name: 'element:spacing',
    title: 'spacing',
    subTitle: '{Number}',
    description: 'The spacing between each letter of the text.',
    url: '/reference/api/engine/classes/ElementComponent.html#spacing'
}, {
    name: 'element:color',
    title: 'color',
    subTitle: '{pc.Color}',
    description: 'The color of the Element.',
    url: '/reference/api/engine/classes/ElementComponent.html#color'
}, {
    name: 'element:opacity',
    title: 'opacity',
    subTitle: '{Number}',
    description: 'The opacity of the Element.',
    url: '/reference/api/engine/classes/ElementComponent.html#opacity'
}, {
    name: 'element:useInput',
    title: 'useInput',
    subTitle: '{Boolean}',
    description: 'Enable this if you want the element to receive input events.',
    url: '/reference/api/engine/classes/ElementComponent.html#useinput'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#batchgroupid'
}, {
    name: 'element:layers',
    title: 'layers',
    subTitle: '{Number[]}',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#layers'
}, {
    name: 'element:outlineColor',
    title: 'outlineColor',
    subTitle: '{pc.Color}',
    description: 'The text outline effect color and opacity.',
    url: '/reference/api/engine/classes/ElementComponent.html#outlinecolor'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#outlinethickness'
}, {
    name: 'element:shadowColor',
    title: 'shadowColor',
    subTitle: '{pc.Color}',
    description: 'The text shadow cast effect color and opacity.',
    url: '/reference/api/engine/classes/ElementComponent.html#shadowcolor'
}, {
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#shadowoffset'
}, {
    name: 'element:enableMarkup',
    title: 'enableMarkup',
    subTitle: '{Boolean}',
    description: 'Flag for enabling markup processing. Only works for text types.',
    url: '/reference/api/engine/classes/ElementComponent.html#enablemarkup'
}, {
    name: 'element:mask',
    title: 'mask',
    subTitle: '{Boolean}',
    ...
    url: '/reference/api/engine/classes/ElementComponent.html#mask'
}];
