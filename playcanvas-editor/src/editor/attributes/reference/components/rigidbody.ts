...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/RigidBodyComponent.html'
}, {
    name: 'rigidbody:linearDamping',
    title: 'linearDamping',
    subTitle: '{Number}',
    description: 'Controls the rate at which a body loses linear velocity over time.',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#lineardamping'
}, {
    ...
    url: '/reference/api/engine/classes/RigidBodyComponent.html#angulardamping'
}, {
    name: 'rigidbody:angularFactor',
    title: 'angularFactor',
    subTitle: '{pc.Vec3}',
    description: 'Scaling factor for angular movement of the body in each axis.',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#angularfactor'
}, {
    name: 'rigidbody:friction',
    title: 'friction',
    subTitle: '{Number}',
    description: 'The friction value used when contacts occur between two bodies.',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#friction'
}, {
    name: 'rigidbody:group',
    title: 'group',
    subTitle: '{Number}',
    description: 'description',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#group'
}, {
    name: 'rigidbody:linearFactor',
    title: 'linearFactor',
    subTitle: '{pc.Vec3}',
    description: 'Scaling factor for linear movement of the body in each axis.',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#linearfactor'
}, {
    name: 'rigidbody:mass',
    title: 'mass',
    subTitle: '{Number}',
    description: 'The mass of the body.',
    url: '/reference/api/engine/classes/RigidBodyComponent.html#mass'
}, {
    ...
    url: '/reference/api/engine/classes/RigidBodyComponent.html#restitution'
}, {
    name: 'rigidbody:type',
    title: 'type',
...
<li><b>Kinematic</b> (<code>pc.BODYTYPE_KINEMATIC</code>): Controlled by code. Not affected by physics but can push dynamic bodies.</li>
    ...
    url: '/reference/api/engine/classes/RigidBodyComponent.html#type'
}, {
    ...
    url: '/reference/api/engine/classes/RigidBodyComponent.html#rollingfriction'
}];
