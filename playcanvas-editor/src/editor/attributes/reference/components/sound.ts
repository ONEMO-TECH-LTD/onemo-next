...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/SoundComponent.html'
}, {
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#positional'
}, {
    name: 'sound:distance',
    title: 'distance',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#refdistance'
}, {
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#maxdistance'
}, {
    name: 'sound:pitch',
    title: 'pitch',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#rollofffactor'
}, {
    name: 'sound:volume',
    title: 'volume',
    subTitle: '{Number}',
...
<li><b>Exponential</b> (<code>pc.DISTANCE_EXPONENTIAL</code>): Volume decreases exponentially with distance.</li>
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#distancemodel'
}];
