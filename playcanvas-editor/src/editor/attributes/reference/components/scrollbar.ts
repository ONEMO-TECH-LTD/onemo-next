...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/ScrollbarComponent.html'
}, {
...
<li><b>Vertical</b> (<code>pc.ORIENTATION_VERTICAL</code>): Scrollbar moves up/down.</li>
    ...
    url: '/reference/api/engine/classes/ScrollbarComponent.html#orientation'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollbarComponent.html#handleentity'
}, {
    name: 'scrollbar:value',
    title: 'value',
    subTitle: '{Number}',
    description: 'The current position value of the scrollbar, in the range 0...1.',
    url: '/reference/api/engine/classes/ScrollbarComponent.html#value'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollbarComponent.html#handlesize'
}];
