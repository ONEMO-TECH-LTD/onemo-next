...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html'
}, {
    name: 'scrollview:horizontal',
    title: 'horizontal',
    subTitle: '{Boolean}',
    description: 'Whether to enable horizontal scrolling.',
    url: '/reference/api/engine/classes/ScrollViewComponent.html#horizontal'
}, {
    name: 'scrollview:vertical',
    title: 'vertical',
    subTitle: '{Boolean}',
    description: 'Whether to enable vertical scrolling.',
    url: '/reference/api/engine/classes/ScrollViewComponent.html#vertical'
}, {
...
<li><b>Infinite</b> (<code>pc.SCROLL_MODE_INFINITE</code>): Content can be scrolled indefinitely.</li>
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#scrollmode'
}, {
    name: 'scrollview:bounceAmount',
    title: 'bounceAmount',
    subTitle: '{Number}',
    description: 'Controls how far the content should move before bouncing back.',
    url: '/reference/api/engine/classes/ScrollViewComponent.html#bounceamount'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#friction'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#usemousewheel'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#mousewheelsensitivity'
}, {
...
<li><b>Show When Required</b> (<code>pc.SCROLLBAR_VISIBILITY_SHOW_WHEN_REQUIRED</code>): Scrollbar only visible when content exceeds viewport.</li>
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#horizontalscrollbarvisibility'
}, {
...
<li><b>Show When Required</b> (<code>pc.SCROLLBAR_VISIBILITY_SHOW_WHEN_REQUIRED</code>): Scrollbar only visible when content exceeds viewport.</li>
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#verticalscrollbarvisibility'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#viewportentity'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#contententity'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#horizontalscrollbarentity'
}, {
    ...
    url: '/reference/api/engine/classes/ScrollViewComponent.html#verticalscrollbarentity'
}];
