...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/CollisionComponent.html'
}, {
    name: 'collision:asset',
    title: 'asset',
    subTitle: '{Number}',
    description: 'The model asset that will be used as a source for the triangle-based collision mesh.',
    url: '/reference/api/engine/classes/CollisionComponent.html#asset'
}, {
...
<li><b>Compound</b> (<code>"compound"</code>): Combines collision shapes from child entities.</li>
    ...
    url: '/reference/api/engine/classes/CollisionComponent.html#type'
}, {
    ...
    url: '/reference/api/engine/classes/CollisionComponent.html#linearoffset'
}, {
    ...
    url: '/reference/api/engine/classes/CollisionComponent.html#angularoffset'
}];
