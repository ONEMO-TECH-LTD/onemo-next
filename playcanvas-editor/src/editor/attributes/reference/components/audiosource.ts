...
export const fields: AttributeReference[] = [{
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html'
}, {
    name: 'audiosource:3d',
    title: '3d',
    subTitle: '{Boolean}',
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#3d'
}, {
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#activate'
}, {
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#assets'
}, {
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#loop'
}, {
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#maxdistance'
}, {
    name: 'audiosource:minDistance',
    title: 'minDistance',
    subTitle: '{Number}',
    description: 'The distance at which the volume of playback begins to fall from its maximum',
    url: '/reference/api/engine/classes/AudioSourceComponent.html#mindistance'
}, {
    ...
    url: '/reference/api/engine/classes/AudioSourceComponent.html#pitch'
}, {
    name: 'audiosource:rollOffFactor',
    title: 'rollOffFactor',
    subTitle: '{Number}',
    description: 'The rate at which volume fall-off occurs.',
    url: '/reference/api/engine/classes/AudioSourceComponent.html#rollofffactor'
}, {
    name: 'audiosource:volume',
    title: 'volume',
    subTitle: '{Number}',
    description: 'The volume of the audio assets played back by the component.',
    url: '/reference/api/engine/classes/AudioSourceComponent.html#volume'
}, {
