...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/ButtonComponent.html'
}, {
    name: 'button:active',
    title: 'active',
    subTitle: '{Boolean}',
    description: 'If set to false, the button will be visible but will not respond to hover or touch interactions.',
    url: '/reference/api/engine/classes/ButtonComponent.html#active'
}, {
    name: 'button:imageEntity',
    title: 'imageEntity',
    subTitle: '{pc.Entity}',
    url: '/reference/api/engine/classes/ButtonComponent.html#imageentity',
    ...
    url: '/reference/api/engine/classes/ButtonComponent.html#hitpadding'
}, {
...
<li><b>Sprite Change</b> (<code>pc.BUTTON_TRANSITION_MODE_SPRITE_CHANGE</code>): The button will use different sprite frames for each state.</li>
    ...
    url: '/reference/api/engine/classes/ButtonComponent.html#hoverspriteasset'
}, {
    name: 'button:hoverSpriteFrame',
    title: 'hoverSpriteFrame',
    subTitle: '{Number}',
    description: 'Frame to be used from the hover sprite.',
    url: '/reference/api/engine/classes/ButtonComponent.html#hoverspriteframe'
}, {
    ...
    url: '/reference/api/engine/classes/ButtonComponent.html#pressedspriteasset'
}, {
    name: 'button:pressedSpriteFrame',
    title: 'pressedSpriteFrame',
    subTitle: '{Number}',
    description: 'Frame to be used from the pressed sprite.',
    url: '/reference/api/engine/classes/ButtonComponent.html#pressedspriteframe'
}, {
    ...
    url: '/reference/api/engine/classes/ButtonComponent.html#inactivespriteasset'
}, {
    name: 'button:inactiveSpriteFrame',
    title: 'inactiveSpriteFrame',
    subTitle: '{Number}',
    description: 'Frame to be used from the inactive sprite.',
    url: '/reference/api/engine/classes/ButtonComponent.html#inactivespriteframe'
}];
