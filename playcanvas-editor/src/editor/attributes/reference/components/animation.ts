...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/AnimationComponent.html'
}, {
    ...
    url: '/reference/api/engine/classes/AnimationComponent.html#assets'
}, {
    ...
    url: '/reference/api/engine/classes/AnimationComponent.html#speed'
}, {
    name: 'animation:activate',
    title: 'activate',
    subTitle: '{Boolean}',
    description: 'If checked, the component will start playing the animation on load.',
    url: '/reference/api/engine/classes/AnimationComponent.html#activate'
}, {
    name: 'animation:loop',
    title: 'loop',
    subTitle: '{Boolean}',
    ...
    url: '/reference/api/engine/classes/AnimationComponent.html#loop'
}];
