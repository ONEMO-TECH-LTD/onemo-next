...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/CameraComponent.html'
}, {
    name: 'camera:clearColor',
    title: 'clearColor',
    subTitle: '{pc.Color}',
    description: 'The color used to clear the camera\'s render target.',
    url: '/reference/api/engine/classes/CameraComponent.html#clearcolor'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#clearcolorbuffer'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#cleardepthbuffer'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#requestscenedepthmap'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#requestscenecolormap'
}, {
    name: 'camera:clip',
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#farclip'
}, {
    name: 'camera:nearClip',
    title: 'nearClip',
    subTitle: '{Number}',
    description: 'The distance in camera space from the camera\'s eye point to the near plane.',
    url: '/reference/api/engine/classes/CameraComponent.html#nearclip'
}, {
    name: 'camera:farClip',
    title: 'farClip',
    subTitle: '{Number}',
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#fov'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#frustumculling'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#orthoheight'
}, {
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#priority'
}, {
...
<li><b>Orthographic</b> (<code>pc.PROJECTION_ORTHOGRAPHIC</code>): No perspective distortion. Useful for 2D games and UI.</li>
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#projection'
}, {
    name: 'camera:rect',
    title: 'rect',
    subTitle: '{pc.Vec4}',
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#rect'
}, {
    name: 'camera:layers',
    title: 'layers',
    subTitle: '{Number[]}',
    description: 'The layers that this camera will render.',
    url: '/reference/api/engine/classes/CameraComponent.html#layers'
}, {
...
<li><b>Neutral</b> (<code>pc.TONEMAP_NEUTRAL</code>): Attempt to preserve original color while compressing brightness.</li>
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#tonemapping'
}, {
...
<li><b>2.2</b> (<code>pc.GAMMA_SRGB</code>): Standard sRGB gamma correction. Recommended for proper color after lighting.</li>
    ...
    url: '/reference/api/engine/classes/CameraComponent.html#gammacorrection'
}];
