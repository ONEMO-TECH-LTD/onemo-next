...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/SoundSlot.html#autoplay'
}, {
    ...
    url: '/reference/api/engine/classes/SoundSlot.html#overlap'
}, {
    name: 'sound:slot:asset',
    title: 'asset',
    subTitle: '{Number}',
    description: 'The audio asset that can be played from this sound slot.',
    url: '/reference/api/engine/classes/SoundSlot.html#asset'
}, {
    ...
    url: '/reference/api/engine/classes/SoundSlot.html#loop'
}, {
    ...
    url: '/reference/api/engine/classes/SoundComponent.html#pitch'
}, {
    name: 'sound:slot:volume',
    title: 'volume',
    subTitle: '{Number}',
    description: 'The volume modifier to play the audio with.',
    url: '/reference/api/engine/classes/SoundComponent.html#volume'
}];
