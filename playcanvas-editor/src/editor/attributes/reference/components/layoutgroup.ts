...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html'
}, {
...
<li><b>Vertical</b> (<code>pc.ORIENTATION_VERTICAL</code>): Child elements are arranged vertically (top to bottom).</li>
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#orientation'
}, {
    name: 'layoutgroup:reverseX',
    title: 'reverseX',
    subTitle: '{Boolean}',
    description: 'Reverses the order of elements on the X axis.',
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#reversex'
}, {
    name: 'layoutgroup:reverseY',
    title: 'reverseY',
    subTitle: '{Boolean}',
    description: 'Reverses the order of elements on the Y axis.',
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#reversey'
}, {
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#alignment'
}, {
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#padding'
}, {
    name: 'layoutgroup:spacing',
    title: 'spacing',
    subTitle: '{pc.Vec2}',
    description: 'Spacing to be applied between each child element.',
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#spacing'
}, {
...
<li><b>Both</b> (<code>pc.FITTING_BOTH</code>): Children are both stretched and shrunk as needed.</li>
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#widthfitting'
}, {
...
<li><b>Both</b> (<code>pc.FITTING_BOTH</code>): Children are both stretched and shrunk as needed.</li>
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#heightfitting'
}, {
    ...
    url: '/reference/api/engine/classes/LayoutGroupComponent.html#wrap'
}];
