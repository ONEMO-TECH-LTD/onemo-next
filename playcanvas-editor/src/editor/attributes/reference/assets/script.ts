...
export const fields: AttributeReference[]  = [{
    ...
    description: 'This allows you to control when this script will be loaded. The possible values are "Asset" (load as a regular Asset), "Before Engine" (load before the Studio engine is loaded), "After Engine" (load right after the Studio engine has loaded)'
}];
