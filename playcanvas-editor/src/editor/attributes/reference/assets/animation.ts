...
export const fields: AttributeReference[]  = [{
    ...
    url: '/reference/api/engine/classes/Animation.html'
}, {
    name: 'asset:animation:name',
    title: 'name',
    description: 'The name of the animation',
    url: '/reference/api/engine/classes/Animation.html#name'
}, {
    name: 'asset:animation:duration',
    title: 'duration',
    description: 'Duration of the animation in seconds.',
    url: '/reference/api/engine/classes/Animation.html#duration'
}];
