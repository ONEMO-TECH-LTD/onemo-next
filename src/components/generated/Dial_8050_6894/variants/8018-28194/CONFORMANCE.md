# Conformance — 8018:28194 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 2 |
| Token coverage (styleable) | **88%** (7 var-decls / 8 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .stateDefault · `gap: 10px` (css:5) → candidates: `--prim-track-pos-10`
- .swatch · `background-color: #d8d33e` (css:19)
