# Conformance — I8019:1570;8018:28205 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 2 |
| Token coverage (styleable) | **100%** (9 var-decls / 9 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .dial · `gap: 10px` (css:5) → candidates: `--prim-track-pos-10`
- .swatch · `background-color: #232323` (css:20)
