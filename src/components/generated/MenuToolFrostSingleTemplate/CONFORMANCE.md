# Conformance — 6103:702 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 7 |
| Token coverage (styleable) | **120%** (7 var-decls / 5 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- 6103:642: partially hidden in-flow children on a HUG container: authored-size preservation is unmeasured; visible content remains content-driven (KAI-9650 bound)
