# Conformance — 6105:18352 @ file v2382071047635827559

| Check | Result |
|---|---|
| Elements (ID map) | 1 |
| Token coverage (styleable) | **100%** (3 var-decls / 3 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- 6105:18352 · layoutMode · baked-auto-layout — auto-layout geometry is baked into the Figma export
