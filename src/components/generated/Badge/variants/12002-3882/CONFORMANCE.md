# Conformance — 12002:3882 @ file v2381318852839647833
...
- .stateActive · `width` = `--sem-dim-fluid-big-l` → resolves **55.37px** but Figma shows **56px** (css:5) — fix the token build or the Figma variable, not the converter
