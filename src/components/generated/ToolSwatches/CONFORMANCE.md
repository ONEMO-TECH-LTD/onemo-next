# Conformance — 8019:1146 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 13 |
| Token coverage (styleable) | **83%** (22 var-decls / 24 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .toolSwatches · `width: 402px` (css:5)
- .swatchMasked · `width: 402px` (css:9)
- .swatchMasked · `height: 32px` (css:10)
- .alpha · `width: 402px` (css:24)
