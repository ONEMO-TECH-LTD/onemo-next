# Conformance — 12002:17754 @ file v2382071047635827559

| Check | Result |
|---|---|
| Elements (ID map) | 3 |
| Token coverage (styleable) | **86%** (7 var-decls / 7 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .lockClosed · `width: 16px` (css:22)
- .lockClosed · `height: 16px` (css:23)
