# Conformance — 8017:20930 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 11 |
| Token coverage (styleable) | **100%** (27 var-decls / 27 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .buttonToggle · `border-radius: 9999px` (css:23)
- .magnetic · `width: 20px` (css:27)
- .magnetic · `height: 20px` (css:28)
