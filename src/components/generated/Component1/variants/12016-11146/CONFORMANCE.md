# Conformance — 12016:11146 @ file v2381318852839647833
...
- .property1Medium · `gap: 10px` (css:4) → candidates: `--prim-track-pos-10`
- .property1Medium · `padding: 18px` (css:5)
- .property1Medium · `width: 288px` (css:6)
- .property1Medium · `height: 288px` (css:7)
