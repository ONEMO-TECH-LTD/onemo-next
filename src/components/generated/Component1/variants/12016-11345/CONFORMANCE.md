...
- .magnetBump · `width: 28px` (css:39)
- .magnetBump · `height: 28px` (css:40)
- .magnetBump2 · `width: 28px` (css:45)
- .magnetBump2 · `height: 28px` (css:46)
- .magnetBump3 · `width: 28px` (css:58)
- .magnetBump3 · `height: 28px` (css:59)
- .magnetBump4 · `width: 28px` (css:64)
- .magnetBump4 · `height: 28px` (css:65)
