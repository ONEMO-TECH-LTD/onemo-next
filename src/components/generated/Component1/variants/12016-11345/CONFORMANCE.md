# Conformance — 12016:11345 @ file v2382085534573304220
...
- .property1Variant4 · `gap: 10px` (css:4) → candidates: `--prim-track-pos-10`
- .property1Variant4 · `padding: 18px` (css:5)
- .property1Variant4 · `width: 288px` (css:6)
- .property1Variant4 · `height: 288px` (css:7)
- .magneticGridSM · `width: 252px` (css:26)
- .magneticGridSM · `height: 252px` (css:27)
- .magnetBump · `width: 28px` (css:40)
- .magnetBump · `height: 28px` (css:41)
- .magnetBump2 · `width: 28px` (css:46)
- .magnetBump2 · `height: 28px` (css:47)
- .magnetBump3 · `width: 28px` (css:59)
- .magnetBump3 · `height: 28px` (css:60)
- .magnetBump4 · `width: 28px` (css:65)
- .magnetBump4 · `height: 28px` (css:66)
