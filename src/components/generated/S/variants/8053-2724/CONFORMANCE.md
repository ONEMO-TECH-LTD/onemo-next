# Conformance — 8053:2724 @ file v2382085534573304220

| Check | Result |
|---|---|
| Elements (ID map) | 2 |
| Token coverage (styleable) | **70%** (7 var-decls / 10 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .sizeMedium · `width: 20px` (css:2)
- .sizeMedium · `height: 20px` (css:3)
- .m · `font-weight: 500` (css:18)
