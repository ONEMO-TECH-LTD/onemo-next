# Conformance — 8019:1593 @ file v2381318852839647833

| Check | Result |
|---|---|
| Elements (ID map) | 2 |
| Token coverage (styleable) | **50%** (1 var-decls / 2 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
| RAW values | 1 (worklist below) |
...
- .toolSwatch · `padding[0]` = `--sem-dim-fluid-nano-xl` → resolves **9.05px** but Figma shows **8px** (css:5) — fix the token build or the Figma variable, not the converter
