# Conformance — 12002:4330 @ file v2381318852839647833
...
- .badge2 · `width` = `--sem-dim-fluid-big-l` → resolves **55.37px** but Figma shows **56px** (css:18) — fix the token build or the Figma variable, not the converter
