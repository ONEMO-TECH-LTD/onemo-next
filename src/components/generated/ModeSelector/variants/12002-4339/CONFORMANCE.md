# Conformance — 12002:4339 @ file v2381318852839647833
...
- .badge3 · `width` = `--sem-dim-fluid-big-l` → resolves **55.37px** but Figma shows **56px** (css:23) — fix the token build or the Figma variable, not the converter
