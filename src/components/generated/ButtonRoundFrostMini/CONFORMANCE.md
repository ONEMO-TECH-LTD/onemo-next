# Conformance — 6104:641 @ file v2382071047635827559

| Check | Result |
|---|---|
| Elements (ID map) | 2 |
| Token coverage (styleable) | **83%** (6 var-decls / 6 styleable) |
| Unresolved `var(--…)` | **0** ✅ |
...
- .undoMini · `width: 16px` (css:13)
- .undoMini · `height: 16px` (css:14)
