...
const masksEqual = (a: Mask, b: Mask): boolean => a.w === b.w && a.h === b.h
...
export function useCutoutLabFlow(adapters: LabAdapters) {
  ...
  }, [activateOutlineSource, invalidatePaintCalibration, requestRender, settleBakes, settleToolQueue])
