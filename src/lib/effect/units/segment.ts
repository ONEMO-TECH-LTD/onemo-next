...
//
// Moved from grid-magnet-compute.ts byte-identical (S2, move class VERBATIM). The only edits are
// the import lines below. edgeDistMM and pointInOuter are still imported from their current home:
