...
import { PHASE_STEP_MM, type GridSystemSpec } from './spec'
...
// has no box.
//
// The bridge itself holds no values (it reads them from Sub 2), does no geometry
// (it asks compute) and makes no product choice (it asks logic).
