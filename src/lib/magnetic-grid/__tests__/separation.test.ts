...
const PHASE_TOP_LEVEL_FUNCTIONS: Record<keyof typeof OWNERS, readonly string[]> = {
  ...
  'magnetic-grid/compute/exact-real.ts': [
    ...
    'sqrtMinusRational', 'isRational', 'evaluatePolynomial', 'normalizedAlgebraicKey', 'validateAlgebraic', 'compareAlgebraicToRational',
    'compareExactToRational', 'refineAlgebraic', 'compareExact', 'affinePolynomial', 'affineExact', 'signQuadraticAtExact',
  ...
  'magnetic-grid/compute/regimes.ts': [
    'qPoint', 'exactBandDomain', 'scaleInBand', 'latticeOffsets', 'enumerateParityClassEvents',
  ],
  'magnetic-grid/compute/identity.ts': [
    'rotr', 'sha256Text', 'contourIdentity', 'contourBoundaryTruth', 'certifyContactWitness',
  ],
