// cutout-ai model sub — SAM2-tiny via transformers.js Sam2Model. Implements SegModel.
// Same verified flow as slimsam but the Sam2 class (transformers.js ≥3.8); kept its own sub per
// the contract (one model = one file, independently swappable).
...
export class Sam2Model implements SegModel {
