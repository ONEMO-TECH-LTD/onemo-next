    ...
    <div style={{ position: 'fixed', inset: 0, display: 'flex', background: '#fff', fontFamily: FONT, color: INK, userSelect: 'none' }}>
      ...
      <main ref={canvasRef} data-authoring-resume-phase={authoringResumePhase} onPointerDown={onDown} onPointerMove={onMove} onPointerUp={onUp} onPointerCancel={onUp}
        ...
        {canvasMode === 'components' && editingComponent && (
          <nav aria-label="Component breadcrumb" data-component-breadcrumb data-component-file={editingComponent.file} style={{ position: 'absolute', top: 12, left: 12, zIndex: 50, display: 'flex', alignItems: 'center', gap: 4, width: 'fit-content', padding: 3, border: '1px solid var(--sem-col-border-secondary)', borderRadius: 'var(--sem-radii-full)', background: 'var(--sem-col-bg-primary)', fontFamily: 'var(--sem-type-fluid-label-xs-font)', fontSize: 'var(--sem-type-fluid-label-xs-size)', lineHeight: 'var(--sem-type-fluid-label-xs-line-height)', letterSpacing: 'var(--sem-type-fluid-label-xs-letter-spacing)' }}>
