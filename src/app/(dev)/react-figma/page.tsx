...
function FigmaField({ icon, letter, value, onChange, onCommit, token, suffix, ariaLabel, mode, modeOptions, onMode, picker = true, width, whiteBg, dim, title, placeholder, inputRole = 'spinbutton' }: {
