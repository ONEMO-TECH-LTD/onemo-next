...
import { normalizeStudioJsonPublic } from './scene-format/onemo-deserialize';
import { onemoColorToHex, type OnemoStudioJson, type OnemoMaterialRole } from './scene-format/onemo-format';
import type {
