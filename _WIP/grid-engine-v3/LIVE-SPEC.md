...
| 3 | Extreme hold: a **T** (one apex + base row of three) when the silhouette exposes it; else 4-corners; else the 3-corner triangle | **Tight wrap**: first millimetre that hold fits. Then flush to 12 mm, then centre. |
