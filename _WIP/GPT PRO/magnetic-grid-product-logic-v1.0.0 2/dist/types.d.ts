...
export type ExactJsonValue = null | boolean | string | readonly ExactJsonValue[] | {
...
export type RegionalPrecedence = "report-only" | "before-gravity" | "between-gravity-and-tight-wrap" | "after-tight-wrap";
...
export type TierBoundaryDecisionJson = {
    ...
    readonly definitionId: string;
    readonly higherValue: {
        readonly holdsUpperMaterial: true;
    };
    readonly lowerValue: {
        readonly holdsUpperMaterial: false;
    };
} | {
...
export interface ProductLogicDocumentJson {
    ...
    readonly ruleDefinitions: {
        ...
        readonly statusPolicy: {
            ...
            readonly kind: "supplied";
        } & Omit<StatusPolicyInput, "assignments">);
    };
