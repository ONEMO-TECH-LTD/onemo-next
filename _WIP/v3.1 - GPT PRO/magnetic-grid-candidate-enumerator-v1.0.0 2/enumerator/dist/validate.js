...
export function validateGrammar(grammar) {
    ...
    if (!isRecord(grammarValue.families)) {
        throw new EnumeratorInputError("INVALID_GRAMMAR_SHAPE", "grammar.families", "expected an object containing exactly the four authoritative families");
    }
    assertExactKeys(grammarValue.families, ["corner-triangle", "full-window", "rectangle-corners", "run"], "grammar.families");
