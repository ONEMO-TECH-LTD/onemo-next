...
export function parseInteger(value: IntegerInput, path: string): bigint {
  ...
  if (!CANONICAL_INTEGER.test(value)) {
    throw new KernelInputError(
      ...
      path,
      "expected a canonical base-10 integer string with no leading zeroes or -0",
    );
  }
  return BigInt(value);
}
...
export function parseRational(input: RationalInput, path: string): Rational {
...
export function parseRationalPoint(input: RationalPointInput, path: string): RationalPoint {
  return {
...
export function rationalJson(value: Rational): RationalJson {
  return {
    numerator: value.numerator.toString() as DecimalInteger,
    denominator: value.denominator.toString() as DecimalInteger,
  };
}

export function rationalPointJson(value: RationalPoint): RationalPointJson {
  return {
...
export function rationalFromScaledInteger(value: bigint, denominator: bigint): Rational {
  return makeRational(value, denominator);
}

export function rationalPointFromScaledIntegers(
  x: bigint,
  y: bigint,
  denominator: bigint,
): RationalPoint {
...
export function approximateSqrtRational(value: RationalJson): number {
