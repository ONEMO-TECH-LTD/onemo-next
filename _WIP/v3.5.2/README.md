> **Superseded 2026-08-23 — prior history.** The final agreed state is [`../v3.5.3/`](../v3.5.3/README.md) (Dan's version ruling). Nothing below is build authority.

# v3.5.2 documentation map — final state

## Canonical authority

1. [`canon/v3.5.2-master-contract.md`](./canon/v3.5.2-master-contract.md) — master v3.5.2-3 (final state; freeze candidate until Dan locks §1 rounding), 197 lines, SHA-256 `0f49b077a455f244ec0033c0d6783242be1b0f6e3443d0b2e1122791fcade2c1`. The only contract.
2. [`canon/T3-surgical-execution-subplan.md`](./canon/T3-surgical-execution-subplan.md) — execution sequence W1 → W2 → S1–S5 → F1 → F2, 32 lines, SHA-256 `8d60c1569edd0ddbccdae205d09373ad112f077f076bfe6772e7b580b7559a3f`.
