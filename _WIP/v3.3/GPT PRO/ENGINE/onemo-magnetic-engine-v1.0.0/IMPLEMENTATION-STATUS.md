...
- Full TypeScript source and compiled ESM for all three packages.
- Neutral exact polygon canonicalisation and final disc-containment proof.
- Adaptive continuous feasible-translation representation.
- Multi-clearance structural component evidence.
...
- Engine and fulfilment verification APIs.
- Unit, regression, adversarial and benchmark harnesses.
- Package-specific and full-delivery ZIP generation.

## Conservative implementation decisions for source gaps

The final source documents still carry unresolved product rows. The package does not silently claim they were supplied:

- 96 mm population: disabled.
- Structural thresholds and pattern permissions: reference defaults, explicitly listed as assumptions.
- Batwoman canonical vector fixture: not invented or bundled.
- Sub-quantum result: `DECISION_INDETERMINATE`.
- B1 guarantee: only when a lawful B1 solution exists.
- Physical tolerances: zero-value reference placeholders; physical fulfilment blocked.
- Maximum outline complexity: configurable 4096 vertices; no silent simplification.
